...
description: "Run Docker-like containers natively on FreeBSD using Podman and ocijail. Pre-built images for Radarr, Sonarr, Plex, Immich and more. No Linux VM required."
hide:
  - navigation
  - toc
---
