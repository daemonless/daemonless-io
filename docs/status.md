...
| :material-check-circle:{ .current } | [n8n](https://github.com/daemonless/n8n/actions/workflows/build.yaml) | latest | 2.10.3 |
...
| :material-close-circle:{ .outdated } | [uptime-kuma](https://github.com/daemonless/uptime-kuma/actions/workflows/build.yaml) | latest | 2.1.3 → **2.2.0** |
