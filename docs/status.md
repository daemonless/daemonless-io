...
| :material-close-circle:{ .outdated } | [homepage](https://github.com/daemonless/homepage/actions) | latest | 1.10.1 → **1.9.0** |
...
| :material-check-circle:{ .current } | [immich-ml](https://github.com/daemonless/immich-ml/actions) | latest | 2.5.2 |
| :material-check-circle:{ .current } | [immich-server](https://github.com/daemonless/immich-server/actions) | latest | 2.5.2 |
