...
Self-hosted digital library with smart shelves, metadata, OPDS support, and built-in reader. **Deprecated** — BookLore development has stopped and the project has been deleted.
